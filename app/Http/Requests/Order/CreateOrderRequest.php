...
class CreateOrderRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'billing_city.string' => 'La ciudad de facturación debe ser una cadena de caracteres.',
            'billing_state.required' => 'El estado de facturación es obligatorio.',
            'billing_state.string' => 'El estado de facturación debe ser una cadena de caracteres.',
            'billing_postal_code.required' => 'El código postal de facturación es obligatorio.',
            'billing_postal_code.string' => 'El código postal de facturación debe ser una cadena de caracteres.',
            'billing_country.required' => 'El país de facturación es obligatorio.',
            'billing_country.string' => 'El país de facturación debe ser una cadena de caracteres.',
